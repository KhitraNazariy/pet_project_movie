...
import scss from './SortTv.module.scss';
import {GenresTv} from "../GenresTv/GenresTv";
...
const SortTv: FC = () => {
    ...
    return (
        <div ref={sortRef} className={scss.sortTv}>
            <div className={scss.sortTv__label}>
                <svg
                    width="10"
                    height="6"
                    viewBox="0 0 10 6"
            ...
            {openPopup && (
                <div className={scss.sortTv__popup}>
                    <ul>
                        {
